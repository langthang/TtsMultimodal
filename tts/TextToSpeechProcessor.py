...
class TextToSpeechProcessor:
    ...
    def generate_video_per_conversation_slide(self, conversation, video_dir, slide_file, audio_file, audio_length):
        ...
        # Uncomment the following lines if you want to convert the slide to PDF first, in new macos
        # try:
        #     subprocess.run(
        #         [
        #             "soffice",
        ...
        # Comment the following lines if you want to convert the slide to PDF first, in new macos
    ...
    def generate_speech_per_new_word(self, new_word, audios_dir, language_code):
        ...
        voice_name = self.speaker_to_voice.get(DEFAULT_SPEAKER, GENDER_TO_GOOGLE_TTS_VOICE_NAMES[DEFAULT_SPEAKER][0])  # Default to a neutral voice
        ...
        self.google_tts.synthesize_speech(
            text=text_to_speak,
            output_filename=audio_file,
            voice_name=GENDER_TO_GOOGLE_TTS_VOICE_NAMES[DEFAULT_SPEAKER][0],
            gender=DEFAULT_SPEAKER,
            language_code=language_code
        )
        ...
        print(f"Synthesized speech for new word {order} : {DEFAULT_SPEAKER}: {text_to_speak} : {voice_name} : {audio_length} : {audio_file}")
